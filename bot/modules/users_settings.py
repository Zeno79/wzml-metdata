...
desp_dict = {'rcc': ['RCʟᴏɴᴇ ɪs ᴀ ᴄᴏᴍᴍᴀɴᴅ-ʟɪɴᴇ ᴘʀᴏɢʀᴀᴍ ᴛᴏ sʏɴᴄ ғɪʟᴇs ᴀɴᴅ ᴅɪʀᴇᴄᴛᴏʀɪᴇs ᴛᴏ ᴀɴᴅ ғʀᴏᴍ ᴅɪғғᴇʀᴇɴᴛ ᴄʟᴏᴜᴅ sᴛᴏʀᴀɢᴇ ᴘʀᴏᴠɪᴅᴇʀs ʟɪᴋᴇ GDʀɪᴠᴇ, OɴᴇDʀɪᴠᴇ...', 'Sᴇɴᴅ ʀᴄʟᴏɴᴇ.ᴄᴏɴғ. \n<b>Tɪᴍᴇᴏᴜᴛ:</b> 𝟼𝟶 sᴇᴄ'],
            'lprefix': ['Lᴇᴇᴄʜ Fɪʟᴇɴᴀᴍᴇ Pʀᴇғɪx ɪs ᴛʜᴇ Fʀᴏɴᴛ Pᴀʀᴛ ᴀᴛᴛᴀᴄᴛᴇᴅ ᴡɪᴛʜ ᴛʜᴇ Fɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ Lᴇᴇᴄʜ Fɪʟᴇs.', 'Sᴇɴᴅ Lᴇᴇᴄʜ Fɪʟᴇɴᴀᴍᴇ Pʀᴇғɪx. Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ Hᴇʀᴇ : <a href="https://t.me/Netflix_Dual">Cʟɪᴄᴋ Mᴇ</a>  \n<b>Tɪᴍᴇᴏᴜᴛ:</b> 𝟼𝟶 sᴇᴄ'],
            'lsuffix': ['Lᴇᴇᴄʜ Fɪʟᴇɴᴀᴍᴇ Sᴜғғɪx ɪs ᴛʜᴇ Eɴᴅ Pᴀʀᴛ ᴀᴛᴛᴀᴄʜᴇᴅ ᴡɪᴛʜ ᴛʜᴇ Fɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ Lᴇᴇᴄʜ Fɪʟᴇs', 'Sᴇɴᴅ Lᴇᴇᴄʜ Fɪʟᴇɴᴀᴍᴇ Sᴜғғɪx. Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ Hᴇʀᴇ : <a href="https://t.me/Netflix_Dual">Cʟɪᴄᴋ Mᴇ</a> \n<b>Tɪᴍᴇᴏᴜᴛ:</b> 𝟼𝟶 sᴇᴄ'],
            'lremname': ['Lᴇᴇᴄʜ Fɪʟᴇɴᴀᴍᴇ Rᴇᴍɴᴀᴍᴇ ɪs ᴄᴏᴍʙɪɴᴀᴛɪᴏɴ ᴏғ Rᴇɢᴇx(s) ᴜsᴇᴅ ғᴏʀ ʀᴇᴍᴏᴠɪɴɢ ᴏʀ ᴍᴀɴɪᴘᴜʟᴀᴛɪɴɢ Fɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ Lᴇᴇᴄʜ Fɪʟᴇs', 'Sᴇɴᴅ Lᴇᴇᴄʜ Fɪʟᴇɴᴀᴍᴇ Rᴇᴍɴᴀᴍᴇ. Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ Hᴇʀᴇ : <a href="https://t.me/Netflix_Dual">Cʟɪᴄᴋ Mᴇ</a> \n<b>Tɪᴍᴇᴏᴜᴛ:</b> 𝟼𝟶 sᴇᴄ'],
            'lcaption': ['Lᴇᴇᴄʜ Cᴀᴘᴛɪᴏɴ ɪs ᴛʜᴇ Cᴜsᴛᴏᴍ Cᴀᴘᴛɪᴏɴ ᴏɴ ᴛʜᴇ Lᴇᴇᴄʜ Fɪʟᴇs Uᴘʟᴏᴀᴅᴇᴅ ʙʏ ᴛʜᴇ ʙᴏᴛ', 'Sᴇɴᴅ Lᴇᴇᴄʜ Cᴀᴘᴛɪᴏɴ. Yᴏᴜ ᴄᴀɴ ᴀᴅᴅ HTML ᴛᴀɢs. Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ Hᴇʀᴇ : <a href="https://t.me/Netflix_Dual">Cʟɪᴄᴋ Mᴇ</a> \n<b>Tɪᴍᴇᴏᴜᴛ:</b> 𝟼𝟶 sᴇᴄ'],
            ...
            'lmeta': ['Yᴏᴜʀ ᴄʜᴀɴɴᴇʟ ɴᴀᴍᴇ ᴛʜᴀᴛ ᴡɪʟʟ ʙᴇ ᴜsᴇᴅ ᴡʜɪʟᴇ ᴇᴅɪᴛɪɴɢ ᴍᴇᴛᴀᴅᴀᴛᴀ ᴏғ ᴛʜᴇ ᴠɪᴅᴇᴏ ғɪʟᴇ', 'ꜱᴇɴᴅ ᴍᴇᴛᴀᴅᴀᴛᴀ ᴛᴇxᴛ ꜰᴏʀ ʟᴇᴇᴄʜɪɴɢ ꜰɪʟᴇꜱ \n <b>ᴡʜᴀᴛ ɪꜱ ᴍᴇᴛᴀᴅᴀᴛᴀ 👉 <a href="https://te.legra.ph/What-is-Metadata-07-03">Cʟɪᴄᴋ Hᴇʀᴇ</a></b>\n\n<b>ᴛɪᴍᴇᴏᴜᴛ :-</b> 𝟼𝟶 sᴇᴄ'],
            }
